...
public class Schedule {
    ...
    /**
     * Constructor for a schedule.  Ready to add stops now
     * @param line
     */
    ...
    /**
     * Adds stops one by one to the schedule
     * @param stopName String name of the stop.  Block number or a station name
     * @param hr The hour of arrival for the stop
     * @param min the minute of arrival for the stop
     */
