...
public class PLC {
    ...
    public boolean verifyRXR(Block prevBlock, Block RXRBlock){
    ...
    public boolean verifyMaintenance(Block prevBlock, Block MaintenanceBlock){
        return vitalMaintenance(prevBlock, MaintenanceBlock);
    }

    private boolean vitalMaintenance(Block prevBlock, Block MaintenanceBlock){
        Expression expression = jexlEvaluator.createExpression(maintenance);
        JexlContext jexlcontent = new MapContext();
        return vitalMaintenanceCalculation(prevBlock, MaintenanceBlock, expression, jexlcontent);
    }

    private boolean vitalMaintenanceCalculation(Block prevBlock, Block MaintenanceBlock, Expression expression, JexlContext jexlcontent){
        boolean result = true;
